    ...
    <WellFoodLayout footer={3}>
      ...
      >
        <span className="marquee-wrap style-two text-white">
          <span className="marquee-inner left">Booze Bites</span>
          <span className="marquee-inner left">Booze Bites</span>
          <span className="marquee-inner left">Booze Bites</span>
        </span>
          ...
          <div className="row align-items-end">
            <div className="col-lg-6">
              ...
              >
                <h1>Savor Boldly</h1>
                <p>
                Flavors that Pair Perfectly with Your Drink
                </p>
              ...
              <div className="row">
                <div className="col-lg-8">
                  <div
                    ...
                    data-aos-offset={50}
                  >
                    <span className="sub-title mb-5">learn About Booze Bites</span>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div
                ...
                data-aos-offset={50}
              >
                <span className="sub-title mb-5">GET IN TOUCH WITH US ON WHATSAPP</span>
            ...
            <div className="col-lg-6">
              ...
              >
                <h6>
                Share your WhatsApp number, and the Booze Bites team will get in touch with you soon!
                </h6>
                <form className="newsletter-form style-two mt-15" action="#">
                  ...
                  SUBMIT <i className="far fa-arrow-alt-right" />
                  </button>
                </form>
